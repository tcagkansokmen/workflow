...
class CalendarController extends Controller
{
    ...
    {
        return View::make('portal.calendar.index');
    }
    ...
    public function team()
    {
        ...
        return View::make('portal.calendar.team', compact('rows', 'dates', 'users', 'gunler', 'holidays'));
    }
    public function onay()
    {
        ...
        return View::make('portal.calendar.onay-tablosu', compact('days', 'dates', 'gunler', 'holidays', 'result', 'month'));
    }
    ...
    {   
        ...
        $firms = Firm::whereIn('id', $firmalar)->get();
        ...
        return View::make('portal.calendar.add',[
          'firms' => $firms,
          'dates' => $calendar,
          'is_past' => $is_past,
          'users' => $users
    ...
    {   
        ...
        $projects = Project::where('firm_id', $project->firm_id)->get();
        $is_past = $data['is_past'] ?? '';
        return View::make('portal.calendar.add',[
          'firms' => $firms,
          'calendar' => $calendar,
