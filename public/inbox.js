...
/***/ (function(module, exports, __webpack_require__) {
 ...
 var KTAppInbox = function () {
   ...
   var _initForm = function _initForm(formEl) {
     ...
     var firm_id = $(".firm_id").attr('data-id');
     var whitelist;
     $.ajax({
       url: '/helper/users/' + firm_id,
       dataType: 'json',
       async: false,
   ...
   var _initAttachments = function _initAttachments(elemId) {}; // Public methods
 ...
 module.exports = __webpack_require__(/*! /Users/tufancagkansokmen/Valet/snap/resources/metronic/js/pages/custom/inbox/inbox.js */"./resources/metronic/js/pages/custom/inbox/inbox.js");
