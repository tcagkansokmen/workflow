...
<div class="widget widget--user-profile-1">
  <div class="widget__head">
    <div class="widget__media">
      @if(Auth::user()->avatar)
        <img src="/uploads/user/{{ Auth::user()->avatar }}" alt="image">
      @else
  ...
  <div class="widget__body">
    <div class="widget__content">
      <div class="widget__info">
        ...
        <a href="#" class="widget__data">{{ Auth::user()->email }}</a>
      </div>
      <div class="widget__info">
        <span class="widget__label">Phone:</span>
        <a href="#" class="widget__data">{{ Auth::user()->phone }}</a>
      </div>
    </div>
    <div class="widget__items">
      <a href="/user/profil" class="widget__item widget__item--active">
      ...
      <a href="/user/sifre-degistir" class="widget__item ">
        <span class="widget__section">
          <span class="widget__icon">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <a href="/firmalar" class="widget__item ">
        <span class="widget__section">
          <span class="widget__icon">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <a href="/mizanlar" class="widget__item" >
        <span class="widget__section">
          <span class="widget__icon">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <a href="/vergi-denetim" class="widget__item">
        <span class="widget__section">
          <span class="widget__icon">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
