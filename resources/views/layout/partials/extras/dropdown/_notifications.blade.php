...
@if (config('layout.extras.notifications.dropdown.style') == 'light')
    <div class="d-flex flex-column pt-12 bg-dark-o-5 rounded-top">
        ...
        <h4 class="d-flex flex-center">
            ...
            <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">{{ $authenticated->notifications() }} yeni</span>
        </h4>

        {{-- Tabs --}}
        <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-primary mt-3 px-8" role="tablist">
            <li class="nav-item">
                <a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications"  >Bildirimler</a>
            </li>
            <!--<li class="nav-item">
...
@else
    <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('media/misc/bg-1.jpg') }}')">
        ...
        <h4 class="d-flex flex-center rounded-top">
            <span class="text-white">Kullanıcı Bildirimleri</span>
            <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">{{ $authenticated->notifications() }} yeni</span>
        </h4>
...
<div class="tab-content">
    ...
    <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
        ...
        <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
            @foreach($authenticated->latestNotifications() as $a)
            <div class="d-flex align-items-center mb-6" style="white-space:nowrap; overflow:hidden;text-overflow: ellipsis; width:100%;" >
                {{-- Symbol --}}
                ...
                <div class="d-flex flex-column font-weight-bold">
                    <a href="{{ $a->redirect }}" class="text-dark text-hover-primary mb-1 font-size-lg">{{ $a->title }}</a>
