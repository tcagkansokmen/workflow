					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
						...
						<div class="d-flex flex-column-fluid flex-column flex-center">
							...
							<div class="login-form login-signin py-11">
								<form class="form general-form" action="{{ route('forget-form') }}" method="POST">
                                @csrf
                                                    <!--begin::Title-->
                                <div class="text-center pb-8">
                                    <h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Parolanızı güvenli bir şekilde sıfırlayabilirsiniz</h2>
                                    <span class="text-muted font-weight-bold font-size-h4">Veya
                                    <a href="{{route('register')}}" class="text-primary font-weight-bolder" id="kt_login_signup">Giriş Yapın</a></span>
                                </div>
									<!--end::Title-->
									<!--begin::Form group-->
									...
									<div class="text-center pt-2">
										<button class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Sıfırlama Talebi</button>
									</div>
									<!--end::Action-->
								</form>
							</div>
