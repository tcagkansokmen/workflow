        ...
        <tbody>
          @foreach($users as $d)
            <tr>
              ...
              <td>
              @if($d->toplam_puan)
                <span class="btn btn-light-success">Oylandı</span>
              @else
                <span class="btn btn-light-danger">Bekliyor</span>
              @endif
              </td>
              <td>
                <a href="#" 
                ...
                data-size="medium" 
                data-url="{{ route('end-year-rate', ['yearly_rating_id' => $d->yearly_rating_id, 'user_id' => $d->user_id]) }}"
                title="Değerlendiren Listesi">
                  <i class="la la-star text-success"></i>
                </a>
              </td>
            </tr>
          @endforeach
