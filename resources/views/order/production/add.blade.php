...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <div class="card-body">
            <form action="{{route('save-production')}}" class="general-form" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="row mt-5 mb-5">
                        <div class="col-sm-12">
                        <strong class="mb-3">Montaj Başlangıç/Bitiş Tarihi</strong>
                        </div>
                        <div class="col-sm-4">
                            @include('components.forms.input', [
                              'label' => 'Montaj Başlangıç Tarihi',
                              'placeholder' => '',
                              'type' => 'text',
                              'help' => '',
                              'name' => 'assembly_start_at',
                              'class' => 'date-format',
                            ])
                        </div>
                        <div class="col-sm-4">
                            @include('components.forms.input', [
                              'label' => 'Montaj Bitiş Tarihi',
                              'placeholder' => '',
                              'type' => 'text',
                              'help' => '',
                              'name' => 'assembly_end_at',
                              'class' => 'date-format',
                            ])
                        </div>
                    </div>
                            ...
                            <div class="dropzone-item-static dz-processing " style="">
                              <div class="dropzone-file">
                                <div class="dropzone-filename" title="some_image_file_name.jpg">
                                  ...
                                  <strong>(
                                  <span><strong><a href="{{ Storage::url('snap/production/') }}{{ $b->filename }}" target="_blank"><i class="flaticon-download"></i> Görüntüle</a></strong></span>)</strong>
                                </div>
                              ...
                              <div class="dropzone-toolbar">
                                <a href="{{ route('delete-production-extra', ['id' => $b->id]) }}" class="dropzone-delete delete-extra" >
                                  <i class="flaticon2-cross"></i>
                                  </a>
                              </div>
                            </div>
