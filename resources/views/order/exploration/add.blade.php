...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <div class="card-body">
            <form action="{{route('save-exploration')}}" class="general-form" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label style="display:block;">* Keşif Yapacak Kişi</label>
                                @component('components.forms.select', [
                                'name' => 'user_id',
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            @include('components.forms.input', [
                              ...
                              'name' => 'company',
                              'class' => '',
                              'value' => isset($detail->company) ? $detail->company : null
                            ])
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-8">
                            @include('components.forms.input', [
                              ...
                              'name' => 'name',
                              'class' => '',
                              'value' => isset($detail->name) ? $detail->name : null
                            ])
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            @include('components.forms.input', [
                              ...
                              'name' => 'phone',
                              'class' => 'phone',
                              'value' => isset($detail->phone) ? $detail->phone : null
                            ])
                        </div>
                        <div class="col-sm-4">
                            @include('components.forms.input', [
                              ...
                              'name' => 'email',
                              'class' => '',
                              'value' => isset($detail->email) ? $detail->email : null
                            ])
                        </div>
                    </div>
                    <hr>
                        ...
                        <div class="form-group row ">
                            <div data-repeater-list="extra" class="col-lg-10">
                                @if(isset($detail))
                                    ...
                                    @endforeach
                                @endif
                                @if(!isset($detail)||!count($detail->extras))
                                  <div data-repeater-item class="form-group align-items-center">
                                      <div class="row">
                                          <div class="col-md-9">
                                              <div class="form-group">
                    ...
                    <hr>
                    <h5>Keşif Dosyaları</h5>
                    <div class="form-group row" style="margin-top:10px;">
                      <div class="col-lg-9">
                        <div class="dropzone dropzone-multi" id="kt_dropzone_5">
                          <div class="dropzone-panel mb-lg-0 mb-2">
                            <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm">Resim veya Dosyaları ekleyin</a>
                          </div>
                            ...
                            <div class="dropzone-item-static dz-processing " style="">
                              <div class="dropzone-file">
                                <div class="dropzone-filename" title="some_image_file_name.jpg">
                                  ...
                                  <strong>(
                                  <span><strong><a href="{{ Storage::url('snap/exploration/') }}{{ $b->filename }}" target="_blank"><i class="flaticon-download"></i> Görüntüle</a></strong></span>)</strong>
                                </div>
                              ...
                              <div class="dropzone-toolbar">
                                <a href="{{ route('delete-exploration-extra', ['id' => $b->id]) }}" class="dropzone-delete delete-extra" >
                                  <i class="flaticon2-cross"></i>
                                  </a>
                              </div>
                            </div>
