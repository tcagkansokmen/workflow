            ...
            <div class="row">
                ...
                <div class="repeater" style="margin-bottom:55px;">
                    <div class="form-group form-group-last row ">
                        ...
                        @if(isset($detail)&&count($detail->personels))
                        @foreach($detail->personels as $p)
                    ...
                    <div class="form-group form-group-last row">
                        ...
                        <a href="javascript:;" data-repeater-create="" class="btn btn-bold btn-sm btn-light-info">
                            <i class="la la-plus"></i> Yeni İrtibat Kişi Ekle
                        </a>
                        </div>
                    </div>
                </div>
