            ...
            <div class="card-body p-0">
              ...
              <div class="card-spacer mb-3 customer_id" data-id="{{ $detail->customer->id }}" id="kt_inbox_reply">
                <div class="card card-custom shadow-sm">
                  <div class="card-body p-0">
                    <!--begin::Form-->
                    <form id="kt_inbox_reply_form" action="{{ route('save-contract-message') }}" method="POST" class="message-form">
                    @csrf
                            ...
                            @foreach($detail->files as $b)
                              <div class="dropzone-item-static dz-processing " style="">
                                ...
                                <div class="dropzone-toolbar">
                                  ...
                                  <a href="" class="dropzone-delete contract-dosya-sil" >
                                    <i class="flaticon2-cross"></i>
                                    </a>
                                </div>
                              </div>
...
$("body").on('click', '.contract-dosya-sil', function(){
