...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <form class="form firm-form" method="post" action="{{ route('save-offer') }}">
              ...
              <div class="col-lg-9">
                <div class="dropzone dropzone-multi" id="kt_dropzone_5">
                  <div class="dropzone-panel mb-lg-0 mb-2">
                    <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm">Teklife Ait Dosya Ekle</a>
                  </div>
                  ...
                  @isset($offer_files)
                   @foreach($offer_files as $b)
                    <div class="dropzone-item-static dz-processing " style="">
                      ...
                      <div class="dropzone-toolbar">
                        <a href="{{ route('delete-offer-file', ['id' => $b->id]) }}" class="dropzone-delete teklif-dosya-sil" >
                          <i class="flaticon2-cross"></i>
                          </a>
                      </div>
                    </div>
