...
<div class="card card-custom">
  <div class="card-header flex-wrap border-0 pt-6 pb-0">
      ...
      <div class="card-toolbar">
          <!--begin::Button-->
          <a href="{{ route('add-received-cheque') }}" class="btn btn-primary font-weight-bolder">
...
@section('scripts')
    ...
    var qrform = $('#teklif-listesi').DataTable({
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('received-cheques-json') }}?{!! \Request::getQueryString() !!}",
        ...
        columns: [
            ...
            { data: 'customer.title', name: 'customer.title', title: 'Müşteri Adı', "render": function (data, type, row) {
            ...
            { data: 'id', name: 'id', title: 'İşlem', "render": function(data, type, row) {
                ...
                var status = ""
                if(!row.status){
                  status = '<a href="{{ route("update-received-cheque") }}/'+data+'" class="btn btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-theme="light" title="Ödendi İşaretle"><i class="fas fa-edit icon-md text-primary"></i></a>&nbsp;'
